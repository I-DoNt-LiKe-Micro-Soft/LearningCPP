...
void SwitchStatementsExample() {
	...
	case 1:
		...
		break;
	case 2:
		std::cout << "Tuesday\0" << std::endl;
		break;
	case 3:
		std::cout << "Wednesday\0" << std::endl;
		break;
	case 4:
		std::cout << "Thursday\0" << std::endl;
		break;
	case 5:
		std::cout << "Friday\0" << std::endl;
		break;
	case 6:
		std::cout << "Saturday\0" << std::endl;
		break;
	case 7:
		std::cout << "Sunday\0" << std::endl;
		break;
	}
}
...
int main () {
	...
	if (MyObj->IsCodingFun == 1) {
		std::cout << "Coding is fun\0" << std::endl;
	}

	else if (MyObj->IsCodingFun == 0) {
		std::cout << "Coding is not fun :(\0" << std::endl;
	}
